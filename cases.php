        ...
        <div class="content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div><div class="stat-number" id="statInProgress">0</div><div class="stat-label">In Progress</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon orange"><i class="fas fa-search"></i></div>
                    <div><div class="stat-number" id="statInReview">0</div><div class="stat-label">In Review</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon green"><i class="fas fa-check-circle"></i></div>
                    <div><div class="stat-number" id="statCompleted">0</div><div class="stat-label">Completed</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon red"><i class="fas fa-times-circle"></i></div>
                    <div><div class="stat-number" id="statRejected">0</div><div class="stat-label">Rejected</div></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon purple"><i class="fas fa-clock"></i></div>
                    <div><div class="stat-number" id="statPending">0</div><div class="stat-label">Pending</div></div>
                </div>
            </div>
            ...
            <div class="toolbar">
                <div class="search-box">
                    ...
                    <input type="text" placeholder="Search by client / case ID" id="searchInput">
                </div>
        ...
        <form id="addForm">
            <div class="fsection">
                <div class="frow">
                    ...
                    <input type="text" id="addClientName" placeholder="Enter client name" required>
                </div>
                <div class="frow">
                    <label>Case Type</label>
                    <select id="addCaseType">
    ...
    <div class="modal-box">
        ...
        <form id="editForm">
            ...
            <div class="fsection">
                <div class="frow">
                    <label>Client Name</label>
                    <input type="text" id="editClientName" placeholder="Enter client name" required>
                </div>
                <div class="frow">
                    <label>Case Type</label>
...
function filterCases() {
    ...
    let filtered = cases.filter(c => {
        const matchKeyword = c.client.toLowerCase().includes(keyword) || c.id.toString().includes(keyword);
...
document.getElementById('addForm').addEventListener('submit', function(e) {
    ...
    const type = document.getElementById('addCaseType').value;
    ...
    filterCases(); // re-render with filters
