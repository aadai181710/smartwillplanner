                ...
                <form method="POST" action="fundinggap.php">
                    ...
                    <div class="accordion-section">
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="desc-text">
                                <i class="fas fa-info-circle" style="color:#b30707;margin-right:6px;"></i> Estate Administration Fee refers to the cost associated with managing and settling an individual's estate after their passing. This includes legal fees, executor fees, court costs, and expenses related to the distribution of assets, payment of debts, and resolution of estate-related matters.
                            </div>
                            <div class="sub-total">
