...
<head>
    ...
    <style>
        ...
        .payment-summary .row .lbl {
            color: #0f3b5c;
        }
        .payment-summary .row .val {
            font-weight: 600;
            color: #1e466e;
        }
        .payment-summary .row.total .val {
            color: #b30707;
            font-size: 1.2rem;
        }
        ...
        .card-details .row input:focus {
            border-color: #b30707;
            box-shadow: 0 0 0 3px rgba(179,7,7,0.1);
        }
        .card-details .row .half {
            flex: 0.5;
            min-width: 100px;
        }
