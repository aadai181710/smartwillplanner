...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
        ...
        .report-card{background:#fff;border-radius:18px;padding:24px 20px;border:1px solid #edf2f7;cursor:pointer;transition:.25s}
        .report-card:hover{transform:translateY(-4px);box-shadow:0 12px 30px rgba(0,0,0,.06)}
        .report-card .icon-wrap{width:52px;height:52px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-size:1.5rem;margin-bottom:16px}
        ...
        .report-card h4{font-size:1.05rem;margin:0 0 4px}
        .report-card p{font-size:.85rem;color:#151515;margin:0}
        .report-card .meta{margin-top:16px;padding-top:14px;border-top:1px solid #f0f4f8;display:flex;justify-content:space-between;align-items:center}
        .report-card .badge{background:#eef3fc;color:#2c2c2c;font-size:.7rem;font-weight:700;padding:3px 14px;border-radius:30px}
        ...
        .page-header h1{font-size:1.5rem;font-weight:700;color:#9a0808;margin:0}
        .date-range{display:flex;align-items:center;gap:10px;font-size:.85rem;flex-wrap:wrap}
        .date-range select{padding:6px 14px;border-radius:30px;border:1px solid #e0eaf2;background:#fff;font-size:.85rem;outline:none;cursor:pointer}
        .btn-outline{background:transparent;color:#870000;border:1px solid #730000;padding:6px 20px;border-radius:30px;font-weight:600;cursor:pointer}
        .btn-outline:hover{background:#e6f0fa}
        .btn-primary{background:#2d7fb9;color:#fff;border:none;padding:6px 20px;border-radius:30px;font-weight:600;cursor:pointer}
    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            <div class="stats-grid">
                <div class="stat-card"><div class="stat-icon green"><i class="fas fa-dollar-sign"></i></div><div class="stat-info"><div class="stat-number">$124,580</div><div class="stat-label">Total Commission</div></div></div>
                <div class="stat-card"><div class="stat-icon blue"><i class="fas fa-file-invoice"></i></div><div class="stat-info"><div class="stat-number">47</div><div class="stat-label">Closed Deals</div></div></div>
                <div class="stat-card"><div class="stat-icon orange"><i class="fas fa-user-check"></i></div><div class="stat-info"><div class="stat-number">32</div><div class="stat-label">Active Clients</div></div></div>
                <div class="stat-card"><div class="stat-icon purple"><i class="fas fa-trophy"></i></div><div class="stat-info"><div class="stat-number">#2</div><div class="stat-label">Ranking</div></div></div>
            </div>
...
<script>
    ...
    document.getElementById('exportBtn').addEventListener('click', () => alert('📥 Exporting report as CSV (demo)'));
